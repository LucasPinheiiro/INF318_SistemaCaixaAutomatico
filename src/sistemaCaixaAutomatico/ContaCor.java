...
public class ContaCor {
	...
	private EstrategiaCobranca eCobranca;

	public ContaCor(String titular, float saldoAtual, int numConta, int senha, EstrategiaCobranca eCobranca) {
		...
		this.eCobranca = eCobranca;
	}

	public void CobrarOperacao(){
		eCobranca.CobrarOperacao(this, senha);
	}
