...
public class TrmCxAut {
	...
	private int getOp() {
		...
		do {
			if (modoAtual==Caixa.MODO_CLIENTE) {  // modo cliente 
				op=getInt
						("opcao: 1 = consulta saldo, 2 = saque, 4 = transferencia entre contas, 8 = modo supervisor, 9 = sai");
	...
	public void iniciarOperacao (){
		...
		while (op!=9) {
			...
			case 4:
				controladorCaixa.Tranferir(getInt("Conta origem"), 
											getInt("Conta destino"), 
											getInt("Senha"), 
											getInt("valor da tranferencia"));
				break;
